      ...
      <div className="min-h-screen bg-gradient-to-br from-white via-neutral-50 to-white dark:from-black dark:via-neutral-950 dark:to-black">
        <div className="container mx-auto px-4 py-16">
          ...
          <section className="mb-20 text-center">
            ...
            <h1 className="mb-4 text-7xl font-bold text-black dark:text-white" style={{ fontFamily: 'Airwaves, sans-serif', letterSpacing: '0.1em' }}>
              Brand Assets
            </h1>
          ...
          <section className="mb-16">
            <div className="mb-8 text-center">
              <h2 className="mb-3 text-5xl font-bold" style={{ fontFamily: 'Bourton, sans-serif', color: '#facf39' }}>
                Brand Identity
              </h2>
            ...
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <Card className="overflow-hidden border border-neutral-800 bg-black text-white shadow-lg dark:border-neutral-700 dark:bg-black">
                <CardContent className="p-0">
                  <div className="bg-gradient-to-br from-black via-neutral-900 to-black flex items-center justify-center p-8">
                  ...
                  <div className="space-y-4 border-t border-neutral-800 bg-neutral-950/60 p-5">
                    <div>
                      <h3 className="mb-1 font-semibold text-white">Brand Symbol</h3>
                      <p className="text-xs text-neutral-400">Interconnected unity icon</p>
                    </div>
              ...
              <Card className="overflow-hidden border border-neutral-800 bg-black text-white shadow-lg dark:border-neutral-700 dark:bg-black">
                <CardContent className="p-8">
                  <div className="mb-6">
                    <h3 className="mb-2 text-2xl font-semibold text-white">Brand Colors</h3>
                    <p className="text-sm text-neutral-400">Official color palette</p>
                  </div>
                  ...
                  <div className="space-y-4">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <p className="font-mono text-sm font-semibold text-white">#FACF39</p>
                        <p className="text-xs text-neutral-400">Primary Golden</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <p className="font-mono text-sm font-semibold text-white">#000000</p>
                        <p className="text-xs text-neutral-400">Secondary Black</p>
                      </div>
                    </div>
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      />
                      <div>
                        <p className="font-mono text-sm font-semibold text-white">#FFFFFF → #F5F5F5</p>
                        <p className="text-xs text-neutral-400">Tertiary White Gradient</p>
                      </div>
                    </div>
                  </div>

                  <div className="mt-6 border-t border-neutral-800 pt-6 dark:border-neutral-700">
                    <h4 className="mb-3 text-sm font-semibold text-white">Typography</h4>
                    <div className="space-y-2 text-sm">
                      <div className="flex justify-between">
                        <span className="text-neutral-400">Wordmark:</span>
                        <span className="font-medium text-white" style={{ fontFamily: 'Airwaves, sans-serif' }}>Airwaves Regular</span>
                      </div>
                      <div className="flex justify-between">
                        <span className="text-neutral-400">Slogan:</span>
                        <span className="font-medium text-white" style={{ fontFamily: 'Bourton, sans-serif' }}>Bourton Bold</span>
                      </div>
                    </div>
                  </div>
                </CardContent>
            ...
            <div className="mt-12">
              <div className="mb-6 text-center">
                <h3 className="text-3xl font-semibold" style={{ fontFamily: 'Bourton, sans-serif', color: '#facf39' }}>
                  Signature Logos
                </h3>
                <p className="text-sm text-neutral-600 dark:text-neutral-400">Available for download in SVG and PNG</p>
              </div>
              <div className="grid gap-6 md:grid-cols-3">
                {FEATURED_LOGOS.map((logo) => (
                  <Card key={logo.name} className="overflow-hidden border border-neutral-800 bg-black text-white shadow-lg dark:border-neutral-700 dark:bg-black">
                    <CardContent className="p-0">
                      <div className={`flex h-64 items-center justify-center p-10 ${logo.backgroundClass}`}>
                      ...
                      <div className="space-y-4 border-t border-neutral-800 bg-neutral-950/60 p-5">
                        <div>
                          <h4 className="text-lg font-semibold text-white">{logo.name}</h4>
                          <p className="text-xs text-neutral-400">{logo.description}</p>
                        </div>
                        <div className="flex flex-wrap gap-2">
                          {Object.entries(logo.formats).map(([format, file]) => (
              ...
              {BRAND_ASSETS.logos.svg.map((logo, index) => (
                ...
                >
                  <CardContent className="p-0">
                    ...
                    <div className="space-y-4 border-t border-neutral-800 bg-neutral-950/60 p-5">
                      <div>
                        <h3 className="mb-1 font-semibold text-white">{logo.name}</h3>
                        <p className="text-xs text-neutral-400">{logo.description}</p>
                      </div>
                      ...
                      <div className="flex items-center gap-2">
                        ...
                        {(logo as any).bgColors?.map((color: string, idx: number) => (
            ...
            <Card className="overflow-hidden border-2 border-[#facf39]/20 bg-gradient-to-br from-white to-neutral-50 shadow-lg dark:from-neutral-900 dark:to-black">
              <CardContent className="p-10">
                <div className="flex items-start gap-6">
                  ...
                  <div>
                    <h3 className="mb-3 text-3xl font-bold text-black dark:text-white" style={{ fontFamily: 'Airwaves, sans-serif', letterSpacing: '0.1em' }}>
                      Brand Guidelines
                    </h3>
                    <div className="space-y-3 text-neutral-700 dark:text-neutral-300">
                      ...
                      <p className="font-semibold" style={{ color: '#facf39' }}>
                        Best Practices: Use SVG for web applications and PNG for presentations and social media.
                      </p>
                    </div>
                  </div>
                </div>
