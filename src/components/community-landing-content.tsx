    ...
    <>
      ...
      <style jsx global>{`
        ...
        .hero-text-shimmer::after {
          ...
          position: absolute;
          inset: 0;
          background: linear-gradient(90deg, transparent 0%, rgba(255,255,255,0.8) 45%, transparent 65%);
          transform: translateX(-120%);
      ...
      <div className="px-4 py-16">
        <div className="container mx-auto max-w-4xl">
          {/* Hero Section */}
          <section className="mb-20 min-h-[90vh] flex flex-col items-center justify-center text-center pt-20 md:pt-24">
                ...
                <div className="space-y-4">
                  <div className="flex items-start gap-3">
                    <Checkbox
                      ...
                      className="mt-0.5 h-5 w-5 border-2 border-[#facf39]/70 bg-black/40 shadow-[0_0_0_4px_rgba(250,207,57,0.15)] data-[state=checked]:bg-[#facf39] data-[state=checked]:border-[#facf39]"
                    />
                    <label
                      htmlFor="questionnaire"
                      className="cursor-pointer text-sm leading-relaxed text-neutral-300 dark:text-neutral-300"
                    >
                      I am willing to fill out an extensive questionnaire as part of the community acceptance process to help us build the most aligned and supportive space possible. *
                    </label>
                  </div>
                  ...
                  <div className="rounded-lg border border-[#facf39]/20 bg-black/30 p-4">
                    <p className="text-xs leading-relaxed text-neutral-300 dark:text-neutral-300">
                      By submitting this form, you consent to receive emails and text messages from New Earth Collective about community updates, events, and questionnaire reminders. Standard messaging rates may apply. You can unsubscribe at any time. We respect your privacy and will handle your information in accordance with our privacy policy.
                    </p>
                  </div>
                </div>
