 ...
 */
export function isSessionExpired(lastActivityAt: Date, expirationMinutes = 30): boolean {
  const now = new Date();
 ...
 */
export function isEmailTokenExpired(timestamp: number, expirationDays = 90): boolean {
