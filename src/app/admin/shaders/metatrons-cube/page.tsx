...
const SHADER_CODE = `// Metatron&apos;s Cube - Sacred Geometry Shader
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl space-y-6 p-8 text-center">
            <h1 className="bg-gradient-to-r from-emerald-400 via-green-400 to-teal-400 bg-clip-text text-5xl font-bold text-transparent">
              Metatron&apos;s Cube
            </h1>
