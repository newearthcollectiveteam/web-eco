# New Earth Collective: Community Vetting Survey (Public Version)

## Section 1: Foundational Alignment (Questions 1-5)

1. **How did you find the New Earth Collective?**
   - [ ] Through Austin's social media content
   - [ ] Referred by a current member (please name them): \_\_\_\_
   - [ ] Through a festival/event/retreat
   - [ ] Through mutual friends/community
   - [ ] Other: \_\_\_\_

2. **In your own words, what does "New Earth" mean to you?**
   - Open text (min. ~50 words)

3. **What is your primary intention for joining this community?**
...
5. **What does "sovereignty" mean to you?**
   - Open text (min. ~30 words)

## Section 2: Inner Work & Readiness (Questions 6-10)
...
7. **Describe a recent moment when you chose authenticity over performance, even though it was uncomfortable. What happened?**
   - Open text (min. ~75 words)
...
## Section 3: Community Contribution & Commitment (Questions 11-13)
...
- [ ] High commitment — active participant
- [ ] Moderate commitment — show up when possible
- [ ] Low commitment — mostly observing/learning
- [ ] I'm not sure yet

13. **This community operates on the principle of "equal participation creates collective intelligence." Are you willing to share space and not dominate conversations?**
...
## Section 4: Boundaries & Safety (Questions 14-15)

14. **We prioritize psychological safety (no unsolicited advice, no spiritual bypassing, no performing for approval, calling each other in with love). Can you commit to these agreements?**
...
15. **Is there anything else you want us to know about you, your journey, or why this community is calling to you right now?**

- Open text (optional)

16. **Optional: Birth date, exact time (am/pm), and birth city/state**

- Open text (optional; helps personalize connection)
