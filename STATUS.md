...
| Dependency Management  | Working | Dependabot security alerts (immediate), version bumps (monthly grouped), Zod 4 ignored until ecosystem ready |
...
| ---------- | ----------------------------------------------------------------------------------------------------- | -------- |
| 2026-03-19 | Framework v1.22.0: feature branch workflow, /collab-setup, /sync-all, multi-dev marked optional       | @matthew |
| 2026-03-19 | Security: Next.js 15.5.14, ESLint 9 migration — 0 vulnerabilities. Enabled Dependabot security alerts | @matthew |
| 2026-03-19 | Tech debt: removed @libsql/client, moved @types to devDeps, a11y fixes, project root tidy             | @matthew |
