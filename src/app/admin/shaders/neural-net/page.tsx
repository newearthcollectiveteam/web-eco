...
const SHADER_CODE = `// The Universe Within - by Martijn Steinrucken aka BigWings 2018
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl space-y-6 p-8 text-center">
            <h1 className="bg-gradient-to-r from-cyan-400 via-blue-400 to-purple-400 bg-clip-text text-5xl font-bold text-transparent">
              Neural Network
            </h1>
            <p className="text-xl text-white/80">
              Mesmerizing interconnected nodes pulsing with consciousness
            </p>
          </div>
        </div>
      </div>
