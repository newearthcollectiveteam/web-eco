...
export function LaunchLanding1Content({ timeLeft }: LaunchLanding1ContentProps) {
  return (
    <>
      {/* Hero Section */}
      <section className="mb-20 text-center">
        ...
        <h1 className="mb-6 text-5xl font-bold leading-tight text-white drop-shadow-2xl md:text-6xl lg:text-7xl">
          <span style={{ fontFamily: 'Airwaves, sans-serif', letterSpacing: '0.05em' }}>
        ...
        <p className="mx-auto mb-10 max-w-3xl text-xl italic text-neutral-300 md:text-2xl">
          ...
          <Card className="w-full border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md sm:w-auto">
            <CardContent className="p-8">
              <div className="mb-4 flex items-center justify-center gap-2 text-[#facf39]">
                ...
                <span className="text-sm font-semibold uppercase tracking-wider">Event Countdown</span>
              </div>
        ...
        <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md">
          <CardContent className="p-8 md:p-12">
            ...
            <div className="space-y-4 text-lg leading-relaxed text-neutral-300">
              ...
              <p>
                This launch party is our first spark. A sacred celebration. A living ceremony. A
                12-hour journey of self-activation, group coherence, soul nourishment, and pure
                ecstatic expression.
              </p>
            </div>
            <div className="mt-8">
      ...
      <section className="mb-20">
        <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md">
          <CardContent className="p-8 md:p-12">
            ...
            <p className="mb-6 text-2xl font-bold text-[#facf39]">Heaven on Earth Vibes</p>
            ...
            <p className="mb-4 text-lg italic text-neutral-200">
              We are weaving together the many beautiful threads of Boulder into one Flower of Life
              field.
            </p>
          ...
          <CardContent className="p-8 md:p-12">
            ...
            <div className="mb-6 space-y-4 text-lg leading-relaxed text-neutral-200">
              <p className="text-2xl font-bold text-white">
                This party is free—because your presence <span className="italic">is</span> the gift.
              </p>
              <p className="text-xl font-bold text-[#facf39]">
                Your Entry = Joining the Skool Community + Bringing a Dish to Share
              </p>
              <p>
                This Skool group will be the living ecosystem of the New Earth Collective—a digital
                temple and sanctuary where we:
              </p>
              ...
              <p className="font-semibold text-white">
                This in-person event is the <span className="text-[#facf39]">foundational heartbeat</span> of
                the digital New Earth Collective. YOU are the roots. And the world is waiting to bloom from
        ...
        <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md">
          <CardContent className="p-8 md:p-12">
            ...
            <div className="mb-8 space-y-4 text-lg leading-relaxed text-neutral-300">
              ...
              <p>
                The ones who carry medicine in their voice, their touch, their laughter, their
                presence.
              </p>
              <p>The ones ready to live in rhythm with the New Earth.</p>
              <p className="text-xl font-semibold text-white">Sound like you?</p>
              <p className="text-white">Then come dance, dream, and create this vision with us.</p>
            </div>
            <Button
              size="lg"
              className="w-full bg-gradient-to-r from-[#facf39] to-[#f59e0b] font-bold text-black transition-all hover:scale-105 md:w-auto"
        ...
        <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-lg backdrop-blur-md">
          <CardContent className="p-6">
            <div className="space-y-2 text-sm text-neutral-300">
              <p className="font-semibold text-[#facf39]">Skool Signup Required for Entry</p>
              <p>Bring a nourishing potluck dish to contribute</p>
              <p>Final party details will be shared via Partiful closer to the event</p>
            </div>
          </CardContent>
        </Card>
        <p
