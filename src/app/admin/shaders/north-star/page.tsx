...
const SHADER_CODE = ` // North Star — diagonals rotate inline (two layers from same direction)
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl space-y-6 p-8 text-center">
            <h1 className="bg-gradient-to-r from-amber-400 via-yellow-400 to-orange-400 bg-clip-text text-5xl font-bold text-transparent">
              North Star
            </h1>
            <p className="text-xl text-white/80">
              Golden guiding beacon with radiant rays and pulsing energy
            </p>
          </div>
        </div>
      </div>
