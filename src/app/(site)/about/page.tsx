...
export const metadata: Metadata = {
  ...
  description:
    "Learn about New Earth Collective — a community of heart-led creators building a regenerative future together.",
  openGraph: {
    title: "About | New Earth Collective",
    description:
      "Learn about New Earth Collective — a community of heart-led creators building a regenerative future together.",
      ...
      <section className="relative flex min-h-[60vh] items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 mx-auto max-w-4xl px-4 pt-24 text-center">
          ...
          <p className="mx-auto mb-8 max-w-2xl text-lg text-white/70">
            Coming Soon — We&apos;re crafting our story. In the meantime, join
            the collective and become part of it.
          </p>
          <Button
            asChild
            size="lg"
