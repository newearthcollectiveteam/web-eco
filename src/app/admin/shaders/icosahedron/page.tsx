...
const SHADER_CODE = `// Icosahedron - Floating 3D Platonic Solid
      ...
      <div className="relative h-screen w-full overflow-hidden bg-black">
        ...
        <div className="pointer-events-none absolute inset-0 flex items-center justify-center">
          <div className="max-w-2xl space-y-6 p-8 text-center">
            <h1 className="bg-gradient-to-r from-orange-400 via-red-400 to-pink-400 bg-clip-text text-5xl font-bold text-transparent">
              Icosahedron
            </h1>
            <p className="text-xl text-white/80">
              Floating 3D Platonic solid with 20 triangular faces
            </p>
          </div>
        </div>
      </div>
