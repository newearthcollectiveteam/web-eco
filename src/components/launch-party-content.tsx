    ...
    <>
      ...
      <div className="px-4 py-16">
        <div className="container mx-auto max-w-4xl">
          {/* Hero Section */}
          <section className="mb-16 pt-12 text-center md:pt-14">
            ...
            <p className="mx-auto mb-10 max-w-3xl text-xl text-neutral-300 italic md:text-2xl dark:text-neutral-300">
            ...
            <div className="mb-8 flex flex-col gap-4 sm:flex-row sm:justify-center">
              ...
              >
                <Button
                  size="lg"
                  data-hero-cta
                  className="group w-full bg-gradient-to-r from-[#f3a51c] via-[#f6c43f] to-[#f6e45b] px-8 py-6 text-lg font-bold text-black shadow-2xl transition-all hover:scale-105 hover:shadow-[#facf39]/50 sm:w-auto"
                  style={{
                    fontFamily: "Airwaves, sans-serif",
                    letterSpacing: "0.05em",
                  }}
              ...
              >
                <Button
                  size="lg"
                  variant="outline"
                  className="group w-full border-2 border-[#facf39] bg-black/40 px-8 py-6 text-lg font-bold text-[#facf39] shadow-lg transition-all hover:scale-105 hover:bg-[#facf39]/10 sm:w-auto"
                  style={{
                    fontFamily: "Airwaves, sans-serif",
                    letterSpacing: "0.05em",
                  }}
            ...
            {/* Event Details */}
            <div className="mb-6 flex flex-col items-center justify-center gap-4 text-lg text-neutral-300 sm:flex-row sm:gap-8 dark:text-neutral-300">
            ...
            <div className="mb-6 flex w-full justify-center">
              <Card className="w-full border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md sm:w-auto dark:bg-black/80">
                <CardContent className="px-4 py-3 sm:px-6 sm:py-4">
                  ...
                  <div className="grid grid-cols-4 gap-2 sm:gap-4">
                    {[
                      ...
                      >
                        <div className="mb-2 flex h-16 w-16 items-center justify-center rounded-xl bg-gradient-to-br from-[#facf39] to-[#f59e0b] shadow-lg sm:h-20 sm:w-20">
                          <span
                        ...
                        <span className="text-xs font-semibold tracking-wider text-neutral-400 uppercase dark:text-neutral-400">
                          {item.label}
                        </span>
                      </div>
                    ))}
              ...
              <CardContent className="p-8 md:p-12">
                ...
                <div className="space-y-4 text-lg leading-relaxed text-neutral-300 dark:text-neutral-300">
                  ...
                  <p>
                    ...
                    <span className="font-bold text-[#facf39]">heart</span> of
                    the New Earth Collective. A diverse, potent, and playful
                    community of facilitators, artists, healers, mystics, and
                    visionaries ready to co-create something greater than
                    ourselves.
                  </p>
                  <p>
                    This launch party is our first spark. A sacred celebration.
                    A living ceremony. An 11-hour journey of self-activation,
                    group coherence, soul nourishment, and pure ecstatic
                    expression.
                  </p>
                </div>
              </CardContent>
          ...
          <section className="mb-20">
            <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md dark:bg-black/80">
              <CardContent className="p-8 md:p-12">
                ...
                <p className="mb-4 text-lg text-neutral-200 italic dark:text-neutral-200">
            ...
            <Card className="border-2 border-[#facf39]/40 bg-gradient-to-br from-[#facf39]/10 to-[#f59e0b]/10 shadow-2xl backdrop-blur-md">
              <CardContent className="p-8 md:p-12">
                ...
                <div className="mb-6 space-y-4 text-lg leading-relaxed text-neutral-200 dark:text-neutral-200">
                  ...
                  <p>
                    This Skool group will be the living ecosystem of the New
                    Earth Collective—a digital temple and sanctuary where we:
                  </p>
            ...
            <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-2xl backdrop-blur-md dark:bg-black/80">
              <CardContent className="p-8 md:p-12">
                ...
                <div className="mb-8 space-y-4 text-lg leading-relaxed text-neutral-300 dark:text-neutral-300">
                  ...
                  <p>
                    The ones who carry medicine in their voice, their touch,
          ...
          <section className="mb-20 text-center">
            <Card className="border-2 border-[#facf39]/20 bg-black/60 shadow-lg backdrop-blur-md dark:bg-black/80">
              <CardContent className="p-6">
                <div className="space-y-2 text-sm text-neutral-300 dark:text-neutral-300">
                  ...
                  <p>
                    Event is FREE - Contribute suggested $25 donation if in
                    capacity!
                  </p>
                  <p>
                    Final party details will be shared via Partiful closer to
                    the event
                  </p>
                </div>
              </CardContent>
            ...
            <p
              className="mt-8 text-2xl text-neutral-300 italic dark:text-neutral-300"
              style={{ fontFamily: "Bourton, sans-serif" }}
            >
