...
const COLOR_CATEGORIES = [
  ...
  { id: "classic", name: "Classic", keywords: ["black", "white", "light"] },
  {
    id: "earth",
    name: "Earth Tones",
    keywords: ["sage", "terracotta", "earth-brown", "olive", "peach", "sand"],
  },
  {
    id: "neutral",
    name: "Sophisticated Neutrals",
    keywords: ["charcoal", "slate", "cream", "gray"],
  },
  {
    id: "jewel",
    name: "Jewel Tones",
    keywords: ["green", "teal", "navy", "purple", "burgundy", "rose"],
  },
  {
    id: "cosmic",
    name: "Cosmic Vibrant",
    keywords: ["cosmic", "indigo", "emerald", "pink", "sunset", "amber"],
  },
  ...
  return (
    <div className="min-h-screen">
        ...
        <section className="mb-20 text-center">
          ...
          <div className="flex flex-col items-center gap-4">
            ...
            <button
              onClick={() =>
                document
                  .getElementById("brand-guidelines")
        ...
        <section className="mb-12">
          ...
          <div className="mb-8">
            ...
            <div className="mt-4 text-center text-sm text-neutral-600 dark:text-neutral-400">
              ...
              of {BRAND_ASSETS.logos.svg.length} variations
            </div>
          </div>
                  ...
                  <CardContent className="p-0">
                    ...
                    >
                      ...
                      <button
                        ...
                        className="absolute top-2 right-2 rounded-lg bg-black/60 p-2 opacity-0 backdrop-blur-sm transition-opacity group-hover:opacity-100 hover:bg-black/80"
              ...
              <div className="grid gap-6 md:grid-cols-2">
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
                    <li className="flex items-start gap-2">
                      ...
                      <span>
                        Use the golden logo on dark backgrounds for maximum
                        impact
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-500">✓</span>
                      <span>
                        Maintain minimum clear space equal to the height of the
                        symbol around the logo
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-500">✓</span>
                    ...
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-500">✓</span>
                      <span>
                        Use PNG format for presentations and print materials
                      </span>
                    </li>
                    <li className="flex items-start gap-2">
                      <span className="text-emerald-500">✓</span>
                      <span>
                        Scale logos proportionally to maintain aspect ratio
                      </span>
                    </li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-sm text-neutral-700 dark:text-neutral-300">
                    ...
                    <li>
                      <span className="font-semibold">Body Text:</span> Use
                      clean sans-serif fonts like Inter or system fonts
                    </li>
                  </ul>
                </div>
              </div>
              ...
              <div className="mt-8 rounded-lg border-2 border-[#facf39]/30 bg-[#facf39]/5 p-6">
                ...
                <div className="grid gap-4 md:grid-cols-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-neutral-700 dark:text-neutral-300">
                      PNG format (300+ DPI) for business cards, flyers, and
                      posters
                    </p>
                  </div>
                </div>
      ...
      {previewLogo && (
        ...
        >
          ...
          >
            ...
            <button
              onClick={() => setPreviewLogo(null)}
              className="absolute top-4 right-4 z-10 rounded-lg bg-black/80 p-2 text-white backdrop-blur-sm transition-colors hover:bg-black"
            >
              <X className="h-6 w-6" />
            </button>
      ...
      <button
        ...
        className="fixed right-8 bottom-8 z-50 flex h-12 w-12 items-center justify-center rounded-full border-2 border-[#facf39]/40 bg-[#facf39]/90 text-black shadow-lg backdrop-blur-sm transition-all hover:border-[#facf39] hover:bg-[#facf39] hover:shadow-xl hover:shadow-[#facf39]/30"
        title="Back to top"
      >
        <svg
          className="h-5 w-5"
